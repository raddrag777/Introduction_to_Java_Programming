/*Revise SubtractionQuizLoop to 
generate ten random addition questions 
for two integers between 1 and 15. 
Dispaly the correct count and test time.*/
...
public class Exercise502 {
   public static void main(String [] args) {
      ...
      while(count < NUMBER_OF_QUESTIONS) {
         ...
         //3. Prompt user to answer question
         System.out.print(
